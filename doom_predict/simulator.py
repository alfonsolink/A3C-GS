...
class simulator():
	...
	def __init__(self,a_size):
		game = DoomGame()
		game.set_doom_scenario_path(".\\vizdoom\\scenarios\\predict_position.wad") #This corresponds to the simple task we will pose our agent
	...
	def move(self,a):
		r = self.game.make_action(self.actions[a])
